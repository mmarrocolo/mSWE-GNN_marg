"""Wrapper: add project root to sys.path then run the warmstart conversion."""
import sys
import os
...
sys.argv = [
    ...
    "--template-pkl",  os.path.join(PROJECT_ROOT, "database", "datasets", "train", "template_100m.pkl"),
